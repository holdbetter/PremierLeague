...
internal class DateAdapter(
...
) : ListAdapter<DateHolder, DateAdapter.DateViewHolder>(DateDiffer) {

    companion object {
        private const val COLORED_PAYLOAD = "DATE_WITH_MATCH"
        private const val SELECTED_PAYLOAD = "SELECTED_DATE"
    ...
    object DateDiffer : DiffUtil.ItemCallback<DateHolder>() {
